...
mkdir "KIPiA_Installer\app\dependencies"  :: ИЗМЕНЕНО: lib -> dependencies
...
:: Создаем запускающий скрипт для пользовательской папки
...
echo. >> "KIPiA_Installer\KIPiA_Management.bat"
echo :: Запускаем приложение >> "KIPiA_Installer\KIPiA_Management.bat"
echo echo Starting KIPiA Management System... >> "KIPiA_Installer\KIPiA_Management.bat"
echo java --module-path "%%INSTALL_DIR%%\app\javafx" ^^>> "KIPiA_Installer\KIPiA_Management.bat"
...
echo. >> "KIPiA_Installer\KIPiA_Management.bat"
echo if errorlevel 1 pause >> "KIPiA_Installer\KIPiA_Management.bat"
...
echo 1. Запустите run.bat >> "KIPiA_Installer\README.txt"
echo 2. Убедитесь что установлена Java 23+ >> "KIPiA_Installer\README.txt"
echo. >> "KIPiA_Installer\README.txt"
