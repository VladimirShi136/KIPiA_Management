...
![Панель инструментов редактора](screenshots/2025-12-14_213840_toolbar.jpg)

### 2.2 Рабочая область
![Рабочая область](screenshots/2025-12-14_213840_workspace.jpg)

### 2.3 Панель статуса
![Панель статуса](screenshots/2025-12-14_213840_statusbar.jpg)
...
![Добавление прибора](screenshots/2025-12-14_213840_addDevice.jpg)
...
- ~~**Прямоугольное выделение** - перетащите мышью с зажатой левой кнопкой~~ (в разработке)
...
2. Появятся ручки изменения:
    ...
    - ~~**Ручка поворота** - вращение~~ (в разработке)
    - ~~**Центральная точка** - перемещение~~ (в разработке)
...
2. В контекстном меню выбираем изменение цвета контура или фона
